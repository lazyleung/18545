...
Project.filter<0>=*33*
Project.filter<10>=timer/*
Project.filter<11>=*IF_LOAD*
Project.filter<12>=Interrupt*
Project.filter<13>=gbc_cpu*
Project.filter<14>=iE
Project.filter<15>=*IE_data
Project.filter<16>=wram/*
Project.filter<17>=*bram_addr*
Project.filter<18>=ppu/video/cf/bg_pallete_arr*
Project.filter<1>=*iobus_data*
Project.filter<2>=router/*
Project.filter<3>=*iobus_addr*
Project.filter<4>=
Project.filter<5>=gbc_cpu/data*
Project.filter<6>=Interrupt/*
Project.filter<7>=*data*
Project.filter<8>=*interrupt*
Project.filter<9>=*timer_interrupt*
