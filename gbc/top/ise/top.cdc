...
Project.filter<0>=*hblank*
Project.filter<10>=*video*
Project.filter<11>=*
Project.filter<12>=*router*
Project.filter<13>=*I_LCDRAM_DATA*
Project.filter<14>=*do*
Project.filter<15>=*ppu/do_video*
Project.filter<16>=*do_video*
Project.filter<17>=*line_count*
Project.filter<18>=*cartridge*
Project.filter<1>=*halt*
Project.filter<2>=*cpu_halt*
Project.filter<3>=*dma*
Project.filter<4>=
Project.filter<5>=*lcdram*
Project.filter<6>=*iobus*
Project.filter<7>=*mem*
Project.filter<8>=*stat*
Project.filter<9>=*addr_ext*
