...
Project.filter<0>=*hdma_state*
Project.filter<10>=*mem*
Project.filter<11>=*stat*
Project.filter<12>=*addr_ext*
Project.filter<13>=*video*
Project.filter<14>=*
Project.filter<15>=*router*
Project.filter<16>=*I_LCDRAM_DATA*
Project.filter<17>=*do*
Project.filter<18>=*ppu/do_video*
Project.filter<1>=*hdma*
Project.filter<2>=*wram*
Project.filter<3>=*dma*
Project.filter<4>=
Project.filter<5>=*hblank*
Project.filter<6>=*halt*
Project.filter<7>=*cpu_halt*
Project.filter<8>=*lcdram*
Project.filter<9>=*iobus*
...
Project.unit<0>.triggerChannel<12><15>=
...
Project.unit<0>.triggerChannel<14><0>=dma/hdma_state_FSM_FFd1
Project.unit<0>.triggerChannel<14><1>=dma/hdma_state_FSM_FFd2
...
Project.unit<0>.triggerPortWidth<14>=2
