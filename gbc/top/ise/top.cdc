...
Project.unit<0>.dataChannel<23>=GPIO_SW_W_IBUF
...
Project.unit<0>.triggerChannel<0><12>=addr_ext<13>
Project.unit<0>.triggerChannel<0><13>=addr_ext<14>
Project.unit<0>.triggerChannel<0><14>=addr_ext<15>
...
Project.unit<0>.triggerChannel<2><0>=GPIO_SW_C_IBUF
