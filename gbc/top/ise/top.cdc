...
Project.unit<0>.dataChannel<24>=router/ioreg_data_out<0>
Project.unit<0>.dataChannel<25>=router/ioreg_data_out<1>
Project.unit<0>.dataChannel<26>=router/ioreg_data_out<2>
Project.unit<0>.dataChannel<27>=router/ioreg_data_out<3>
Project.unit<0>.dataChannel<28>=router/ioreg_data_out<4>
Project.unit<0>.dataChannel<29>=router/ioreg_data_out<5>
Project.unit<0>.dataChannel<2>=gbc_cpu/addr_buf/q<2>
Project.unit<0>.dataChannel<30>=router/ioreg_data_out<6>
Project.unit<0>.dataChannel<31>=router/ioreg_data_out<7>
